...
DEFAULT_KEYWORDS = {
    ...
    "Event-based SLAM": (
        '"event-based SLAM" OR "event camera SLAM" OR "event-based visual odometry" '
        'OR ("event camera" AND (SLAM OR odometry OR "visual odometry"))'
    ),
    "Underwater / Radar SLAM": (
        '"underwater SLAM" OR "sonar SLAM" OR "acoustic SLAM" OR "radar SLAM" OR '
        '"radar odometry" OR "radar-inertial odometry" OR '
        '("underwater" AND (SLAM OR odometry))'
    ),
    # Problem type
    "Semantic SLAM": (
    ...
    "Loop Closure / Place Recognition": (
        '"loop closure" OR "loop closure detection" OR "place recognition" OR '
        '"visual place recognition" OR "LiDAR place recognition" OR '
